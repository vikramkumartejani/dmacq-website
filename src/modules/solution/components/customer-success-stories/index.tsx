...
const CustomerSuccessStories = () => {
  ...
  const stories: Story[] = [
    {
      ...
      title: (
        <>
          ...
          <span className="text-[#167B59]">50% faster</span> after implementing
          DMS+
        </>
      ),
      description:
  ...
  return (
    <div className="w-full md:px-8 px-4 py-[64px] md:py-[96px] bg-[#F5F8FF]">
      <div className="w-full max-w-[1184px] mx-auto text-center">
        <h3 className="text-[#167B59] text-base md:text-lg leading-[19.2px] md:leading-[21.6px] font-bold tracking-[4px] uppercase">
          ...
          >
            {stories.map((story, index) => (
              <SwiperSlide key={index}>
                <div className="border border-[#167B593D] bg-white rounded-[16px] p-5 md:p-12 flex items-center flex-col lg:flex-row gap-4 md:gap-[72px]">
                  <Image
                    src={story.image}
                    alt="Customer Story"
                    draggable="false"
                  ...
                  <div>
                    <div className="lg:max-w-[623px] w-full mx-auto pb-6 border-b border-primary-400">
                      <h5 className="text-[#0F553E] text-base font-semibold leading-[24px]">
                        {story.industry}
                      </h5>
            ...
            <div className="flex items-center gap-1.5">
              {stories.map((_, index) => (
                <button
                  ...
                  className={`${
                    currentSlide === index
                      ? "bg-[#167B59] w-[23px] h-[8px] rounded-full"
                      : "bg-[#167B593D] w-[8px] h-[8px] rounded-full"
                  }`}
                />
              ))}
            </div>
