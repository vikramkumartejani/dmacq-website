      ...
      <div className="w-full bg-green-700 rounded-lg md:rounded-[32px] p-8 md:p-12 xl:p-[72px] flex items-center gap-5 justify-between">
        <div className="lg:max-w-[484px]">
          ...
          <p className="text-white text-[16px] leading-[27.2px] font-normal">
            Discover How Our Innovative Products DMS, Form Automation, Workflow
            Solutions, and Digitization, Can Streamline Your Business Operations
            and{" "}
          </p>
          <button className="mt-12 w-full md:w-[133px] h-[40px] bg-white text-green-700 rounded-lg text-base font-semibold">
            Contact Us
          </button>
        </div>
